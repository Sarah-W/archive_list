...
<div class="container">
	<div class="sidebar">
		<DnzSearchBox bind:results bind:searchparams bind:incrementPage bind:decrementPage />
		...
		<div class="results">
			{#await results then docs}
				...
				{#each docs.search.results as document}
					<div draggable="true" on:dragstart={(e) => dragstart(e, document)}>
						<!-- {document.id} -->
						<LittleDoc {document} />
					</div>
				{/each}
	...
	<div class="main" on:drop={drop} on:dragover={dragover}>
